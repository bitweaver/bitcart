...
<h2 align="center">Dynamic Text Sequence Maintenance</h2>
<hr />
<p></p>
...
<b>Modify Text Sequences</b>

</td></tr>
<tr><td align="center" colspan="2" bgcolor="#FFFFFF">

<form name="textform" method="post" action="auxtextupd.php">
<input type="hidden" name="act" value="seq" />

Enter the text sequence numbers in the<br />
...
$i=0;$j=10;
$fcc = new FC_SQL;
$fcc->query("select rid,title,seq from auxtext order by seq"); 
