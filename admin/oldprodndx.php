...
<b>
Delete An Existing Listing</b><br />

</td></tr>
<tr><td align="center" valign="top" bgcolor="#ffffff">

<form method="post" action="oldprodmod.php">

To modify an existing Closeout Product<br />
...
<?php 
$fco->query("select * from oprod where ozid=$zoneid order by oprodsku"); 
while ( $fco->next_record() ) {
    $sku = $fco->f('oprodsku');?>
    <option value="<?php echo $sku?>"><?php 
...
To delete an existing Closeout Product<br />
