...
<h2 align=center>Category Sequence Maintenance</h2>
<hr>
<p>
...
<b>Modify Category Sequences</b><br>
...
<?php 
$fcc->query("select catval,catdescr,catunder from cat ".
	"where catzid=$zoneid and catlid=$langid order by catunder,catseq"); 
...
?>
<tr><td bgcolor="#FFFFFF"><?php echo $cunder.':'.$cid.' '.substr($cdescr,0,40); ?><br></td><td bgcolor="#FFFFFF">
<input name="catseq<?php echo $i?>" size="5" value="<?php echo $j?>">
<input type="hidden" name="catval<?php echo $i?>" value="<?php echo $cid?>">
<br></td></tr>
<?php  $i++;  $j+=10;
}
?>
...
<input type=hidden name=catcount value=<?php echo $i?>>
