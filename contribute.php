...
// This file is for a contribution only order; no products are shown,
...
if(isset($purchid)){
	// purchid provided by cartid.php
	$fcc->query("select * from cust where custid=$purchid");
	$cc = $fcc->next_record();
}else{
	$custid=0;
}
...
<h2 align="center"></h2>
<h3 align="center"><?php echo fc_text('contribution'); ?></h3>
...
<table class="text" border="0" cellpadding="5" cellspacing="1" width="580" bgcolor="#666666">
<tr><td class="subdivrow" colspan="2" align="left" valign="middle" bgcolor="#FFFFFF">
<b><?php echo fc_text('contribamount'); ?></b><br />
</td><td class="contributecell" colspan="2" align="left" valign="top" bgcolor="#FFFFFF">

<form method="post" name="oform" action="<?php echo $securl.$secdir.'/'.$proc ?>"
 onSubmit="
  if( document.oform.contamt.value == '' ){
   alert('<?php echo fc_text('jscontrib'); ?>');
   return false;
  }else if( document.oform.contamt.value > 99999.00 ){
 ...
 ">
<?php echo $csym?><input type="text" name="contamt" size="8" />

</td></tr>
<tr><td class="divrow" colspan="4" align="center" bgcolor="#CCCCCC">
<b><?php echo fc_text('billinfo'); ?></b><br />
</td></tr>
<tr><td class="contributecell" colspan="4" bgcolor="#FFFFFF">
...
<tr><td class="contributecell" align="left" valign="middle" colspan="2" bgcolor="#FFFFFF">

<?php echo fc_text('ccname') . fc_text('reqflag'); ?><br />
<input type="text" name="cc_name" size="40" maxsize="30" /><br />

</td><td class="contributecell" colspan="2" valign="middle" align="center" bgcolor="#FFFFFF">
...
</td><td class="contributecell" align="center" valign="middle" colspan="2" bgcolor="#FFFFFF">

<?php echo fc_text('ccexpire'); ?><br />
<table class="text" border="0">
<tr><td class="contributecell" align="center "valign="top" bgcolor="#FFFFFF">
<?php echo fc_text('month') . fc_text('reqflag'); ?><br />
</td><td class="contributecell" align="center" valign="top" bgcolor="#FFFFFF">
<?php echo fc_text('year') . fc_text('reqflag'); ?><br />
</td></tr><tr><td class="contributecell" align="center" valign="top" bgcolor="#FFFFFF">
...
<tr><td class="contributecell" align="center" colspan="4" bgcolor="#FFFFFF" bgcolor="#FFFFFF">
<?php
...
<tr><td class="contributecell" colspan="4" align="center" bgcolor="#FFFFFF">
...
<input type="submit" value="<?php echo fc_text('contribsubmit'); ?>" />
</form>
